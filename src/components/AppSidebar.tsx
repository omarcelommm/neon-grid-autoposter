...
export function AppSidebar() {
  ...
  return (
    <aside className="w-64 min-h-screen border-r border-border flex flex-col" <aside className="w-64 min-h-screen border-r border-border flex flex-col bg-sidebar">>
